...
Ahk2Exe.exe /base %BASE% /in "windows-accent-layers.ahk" /out "build\windows-accent-layers.exe"
...
xcopy /Q /I keymaps build\keymaps
del build\keymaps\custom*
...
set "OUTPUT=windows-accent-layers-v%VERSION%.zip"
